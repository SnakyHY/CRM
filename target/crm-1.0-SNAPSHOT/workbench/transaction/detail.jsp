<%@ page import="com.snakyhy.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.snakyhy.crm.workbench.domain.Tran" %>
...
<body>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b id="stage">${t.customerId}</b></div>
