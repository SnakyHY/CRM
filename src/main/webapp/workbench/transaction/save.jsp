 ...
 */
		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				//取得选中的阶段
				var stage=$("#create-stage").val();//this.val()

				//取中可能性
				//stage变量为可变的，无法通过该方式取值，需要使用json[key]取值
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="089624e0274b4132be30a4db68acf0c5" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="44b22bba7f5d45f2b4f127e3f675e75b" name="contactsId">
			</div>
		</div>
